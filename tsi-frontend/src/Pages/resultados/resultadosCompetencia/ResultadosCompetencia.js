...
import "./ResultadosCompetencia.css";

function ResultadosCompetencia() {
  const [params] = useSearchParams();
  const competenciaid = params.get("competencia");
  const nombreCompetencia = params.get("nombreCompetencia");
      ...
      <div className="page-container-resultados">
        <div className="tabla-resultados">
          <div className="bloque">
            <h1 className="cabezal">{nombreCompetencia}</h1>
            <br />
            {tabla !== null ? (
              tabla.league.standings.map((grupo, index) => {
                return (
                  <div className="tablas" key={index}>
                    <h1 className="cabezal">{grupo[0].group}</h1>
                    <br />
                    <Table>
                      <thead>
                        <tr>
